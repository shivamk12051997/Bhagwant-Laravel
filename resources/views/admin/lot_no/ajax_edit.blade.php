    ...
    <div class="modal-body dark-modal">
        <div class="row">
            <div class="col-md-6 form-group mb-3">
                ...
                <input type="text" class="form-control" name="lot_no" id="lot_no" value="{{ $lot_no->lot_no ?? '' }}" oninput="$('#error_box').hide(200); $('#lot_no').removeClass('is-invalid');" required>
            ...
            <div class="col-md-6 form-group mb-3">
                ...
                <select class="form-select js-example-basic-single" name="size_id" id="size_id" required>
                    <option value="" selected disabled>Select Option...</option>
                    @foreach (App\Models\Size::where('status',1)->latest()->get() as $size)
